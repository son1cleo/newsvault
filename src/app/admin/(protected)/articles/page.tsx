    ...
    <div>
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        <Link
          ...
          className="flex cursor-pointer items-center gap-2 border-2 border-ink bg-ink px-4 py-2 font-mono text-xs uppercase tracking-widest text-paper transition-colors hover:bg-transparent hover:text-ink"
        >
      ...
      <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 border-b border-rule font-mono text-xs uppercase tracking-widest">
        {TABS.map((tab) => {
